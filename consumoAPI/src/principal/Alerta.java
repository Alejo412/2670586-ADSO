...
public class Alerta extends javax.swing.JFrame {
    ...
    public void initAlternComponents(){
        ...
        setIconImage( getToolkit().createImage( ClassLoader.getSystemResource("img/icono_warning.png") ) );
        
        Image img_warning = getToolkit().createImage( ClassLoader.getSystemResource("img/icono_warning.png") );
